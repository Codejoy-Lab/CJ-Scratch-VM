...
builtinExtensions['handpose2scratch'] = () => require('../extensions/scratch3_handpose2scratch');

builtinExtensions['handpose2scratch'] = () => require('../extensions/scratch3_handpose2scratch');

builtinExtensions['facemesh2scratch'] = () => require('../extensions/scratch3_facemesh2scratch');

builtinExtensions['ic2scratch'] = () => require('../extensions/scratch3_ic2scratch');

builtinExtensions['speech2scratch'] = () => require('../extensions/scratch3_speech2scratch');

builtinExtensions['scratch2maqueen'] = () => require('../extensions/scratch3_scratch2maqueen');
